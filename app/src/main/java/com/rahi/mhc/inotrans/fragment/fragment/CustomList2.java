...
//
    public CustomList2(Activity context, String[] stpa,String[] stp1,String[] stp2,String[] stp3,String[] stp4,String[] stp5,String[] stp6,String[] stp7,String[] stp8,String[] stp9,String[] stp10,String[] stp11,String[] stp12,String[] stp13,String[] stp14,String[] stp15,String[] stp16,String[] stp17,String[] stp18,String[] stp19) {
        super(context, R.layout.singlebus, stpa);
...
//        this.lng=longitude;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        View listViewItem = inflater.inflate(R.layout.singlebus, null, true);
...
//        TextView textViewEmail = (TextView) listViewItem.findViewById(R.id.address);
...
//        TextView textviewcncl= (TextView) listViewItem.findViewById(R.id.cncl);
        TextView tvbusa=(TextView) listViewItem.findViewById(R.id.busA);
        ...
        TextView tvbus19=(TextView) listViewItem.findViewById(R.id.bus19);
